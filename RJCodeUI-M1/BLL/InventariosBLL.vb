...
Public Class InventariosBLL
    ...
    Public Function BuscarTodos(Optional Ano As String = "", Optional Setor As String = "", Optional Abertos As String = "", Optional TextoPesquisa As String = "") As List(Of InventariosDTO)
    ...
    Public Function Maximo()
        Try
            Return inventariosDAL.GetMax("id_inventario", " AND ")
        Catch ex As Exception
