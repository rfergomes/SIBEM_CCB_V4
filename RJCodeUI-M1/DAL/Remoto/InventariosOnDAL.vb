...
Public Class InventariosOnDAL
    Inherits GenericDAL(Of InventariosOnDTO)

    Private ReadOnly Tabela = "inventarios"
    Private ReadOnly TabelaViews = "inventarios"
    ...
    Public Overrides Function GetById(inventariosId As String) As InventariosOnDTO
        ...
        Dim lista As List(Of InventariosOnDTO) = BuscarLista(TabelaViews, columns, $"AND id_inventario = '{inventariosId}'")
    ...
    Public Overrides Function GetByIdList(inventariosId As Integer) As List(Of InventariosOnDTO)
        Dim columns As New Dictionary(Of String, Object)()
        Return BuscarLista(TabelaViews, columns, $"AND id_inventario = {inventariosId}")
    End Function

    Public Overrides Function GetAllList(Optional condicao As String = "") As List(Of InventariosOnDTO)
        Dim columns As New Dictionary(Of String, Object)()
    ...
    Public Overrides Function GetByPart(part As String) As InventariosOnDTO
    ...
    Protected Overrides Function ConvertFromReader(reader As Common.DbDataReader) As InventariosOnDTO
        Dim inventarios As New InventariosOnDTO()
        ...
        Try
            ...
            If ColumnExists(reader, "id_inventario") AndAlso Not reader.IsDBNull(reader.GetOrdinal("id_inventario")) Then
                If reader.GetFieldType(reader.GetOrdinal("id_inventario")) = GetType(Int32) Then
                    inventarios.Id = reader.GetInt32(reader.GetOrdinal("id_inventario"))
                End If
            End If
            ...
            If ColumnExists(reader, "data") AndAlso Not reader.IsDBNull(reader.GetOrdinal("data")) Then
                If reader.GetFieldType(reader.GetOrdinal("data")) = GetType(String) Then
                    inventarios.Data = reader.GetString(reader.GetOrdinal("data"))
                End If
            End If
            ...
            If ColumnExists(reader, "inicio") AndAlso Not reader.IsDBNull(reader.GetOrdinal("inicio")) Then
                inventarios.Inicio = reader.GetString(reader.GetOrdinal("inicio"))
            End If

            If ColumnExists(reader, "termino") AndAlso Not reader.IsDBNull(reader.GetOrdinal("termino")) Then
                inventarios.Termino = reader.GetString(reader.GetOrdinal("termino"))
            End If

            If ColumnExists(reader, "tempo") AndAlso Not reader.IsDBNull(reader.GetOrdinal("tempo")) Then
                Dim tempoValue = reader.GetValue(reader.GetOrdinal("tempo"))

                If TypeOf tempoValue Is TimeSpan Then
                    ' Já é um TimeSpan, atribua diretamente
                    inventarios.Duracao = DirectCast(tempoValue, TimeSpan)
                ElseIf TypeOf tempoValue Is String Then
                    ' É uma string, tente converter para TimeSpan
                    Dim duracao As TimeSpan
                    If TimeSpan.TryParse(tempoValue.ToString(), duracao) Then
                        inventarios.Duracao = duracao
                    Else
                        ' Tratar falha de conversão
                        Throw New Exception($"Erro ao converter '{tempoValue}' para TimeSpan.")
                    End If
                End If
            End If

            If ColumnExists(reader, "bens_lidos") AndAlso Not reader.IsDBNull(reader.GetOrdinal("bens_lidos")) Then
                inventarios.Bens_Lidos = reader.GetInt32(reader.GetOrdinal("bens_lidos"))
            End If

            If ColumnExists(reader, "bens_pendentes") AndAlso Not reader.IsDBNull(reader.GetOrdinal("bens_pendentes")) Then
                inventarios.Bens_Pendentes = reader.GetInt32(reader.GetOrdinal("bens_pendentes"))
            End If

            If ColumnExists(reader, "bens_novos") AndAlso Not reader.IsDBNull(reader.GetOrdinal("bens_novos")) Then
                inventarios.Bens_Novos = reader.GetInt32(reader.GetOrdinal("bens_novos"))
            End If

            If ColumnExists(reader, "bens_inicial") AndAlso Not reader.IsDBNull(reader.GetOrdinal("bens_inicial")) Then
                inventarios.Bens_Inicial = reader.GetInt32(reader.GetOrdinal("bens_inicial"))
            End If
            ...
            If ColumnExists(reader, "bens_final") AndAlso Not reader.IsDBNull(reader.GetOrdinal("bens_final")) Then
                inventarios.Bens_Final = reader.GetInt32(reader.GetOrdinal("bens_final"))
            End If
            ...
            If ColumnExists(reader, "pdf") AndAlso Not reader.IsDBNull(reader.GetOrdinal("pdf")) Then
                If reader.GetFieldType(reader.GetOrdinal("pdf")) = GetType(String) Then
                    inventarios.Pdf = reader.GetString(reader.GetOrdinal("pdf"))
                End If
            End If

            If ColumnExists(reader, "id_admlc") AndAlso Not reader.IsDBNull(reader.GetOrdinal("id_admlc")) Then
                If reader.GetFieldType(reader.GetOrdinal("id_admlc")) = GetType(Integer) Then
                    inventarios.Id_Admlc = reader.GetInt32(reader.GetOrdinal("id_admlc"))
                End If
            End If
        ...
        Catch ex As Exception
            ...
            Throw New Exception("Erro ao converter os dados do reader para InventariosOnDTO", ex)
        End Try
    End Function
