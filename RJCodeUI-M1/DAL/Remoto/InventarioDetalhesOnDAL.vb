...
Public Class InventarioDetalhesOnDAL
    Inherits GenericDAL(Of InventarioDetalhesOnDTO)

    Private ReadOnly Tabela = "inventario_detalhes"
    Private ReadOnly TabelaViews = "inventario_detalhes"
    ...
    Public Function GetAllListByTable(Optional Tabela As String = "", Optional condicao As String = "") As List(Of InventarioDetalhesOnDTO)
        Dim columns As New Dictionary(Of String, Object)()
    ...
    Public Overrides Function GetByPart(part As String) As InventarioDetalhesOnDTO
    ...
    Protected Overrides Function ConvertFromReader(reader As Common.DbDataReader) As InventarioDetalhesOnDTO
        Dim inventario_detalhes As New InventarioDetalhesOnDTO()
        ...
        Try
            ...
            If ColumnExists(reader, "id_detalhe") AndAlso Not reader.IsDBNull(reader.GetOrdinal("id_detalhe")) Then
                If reader.GetFieldType(reader.GetOrdinal("id_detalhe")) = GetType(Int32) Then
                    inventario_detalhes.Id = reader.GetInt32(reader.GetOrdinal("id_detalhe"))
                End If
            End If
            ...
            If ColumnExists(reader, "id_bem") AndAlso Not reader.IsDBNull(reader.GetOrdinal("id_bem")) Then
                If reader.GetFieldType(reader.GetOrdinal("id_bem")) = GetType(String) Then
            ...
            If ColumnExists(reader, "id_dependencia") AndAlso Not reader.IsDBNull(reader.GetOrdinal("id_dependencia")) Then
                If reader.GetFieldType(reader.GetOrdinal("id_dependencia")) = GetType(Int32) Then
                    inventario_detalhes.Id_dependencia = reader.GetInt32(reader.GetOrdinal("id_dependencia"))
                End If
            End If
            ...
            If ColumnExists(reader, "cont") AndAlso Not reader.IsDBNull(reader.GetOrdinal("cont")) Then
                If reader.GetFieldType(reader.GetOrdinal("cont")) = GetType(Int32) Then
                    inventario_detalhes.Contagem = reader.GetInt32(reader.GetOrdinal("cont"))
                End If
            End If

            If ColumnExists(reader, "qtde") AndAlso Not reader.IsDBNull(reader.GetOrdinal("qtde")) Then
                If reader.GetFieldType(reader.GetOrdinal("qtde")) = GetType(Int32) Then
                    inventario_detalhes.Qtde = reader.GetInt32(reader.GetOrdinal("qtde"))
                End If
            End If
        ...
        Catch ex As Exception
            ...
            Throw New Exception($"Erro ao converter os dados do reader para InventarioDetalhesOnDTO {reader.Read} {vbNewLine}{ex.Message}", ex)
        End Try
    End Function
