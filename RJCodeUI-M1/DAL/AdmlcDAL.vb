Public Class AdmlcDAL
    ...
    Public Overrides Function Insert(admlc As AdmlcDTO) As Long
    ...
    Public Overrides Sub Update(admlc As AdmlcDTO)
        Dim columns As New Dictionary(Of String, Object) From {
            {"adm_local", admlc.Adm_Local},
            {"razao_social", admlc.Razao_Social},
            {"cnpj", admlc.CNPJ},
        ...
        Atualizar(Tabela, columns, $"AND id_admlc = '{admlc.Id}'")
    End Sub
    ...
    Public Overrides Function GetByIdList(admlcId As Integer) As List(Of AdmlcDTO)
        Dim columns As New Dictionary(Of String, Object)()
