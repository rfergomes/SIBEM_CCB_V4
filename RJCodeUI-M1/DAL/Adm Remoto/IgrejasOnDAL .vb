...
Public Class IgrejasOnDAL
    Inherits GenericDAL(Of IgrejasOnDTO)
    ...
    Public Overrides Function GetById(igrejasId As String) As IgrejasOnDTO
        ...
        Dim lista As List(Of IgrejasOnDTO) = BuscarLista(TabelaViews, columns, $"AND id_igreja = '{igrejasId}' AND id_admlc = {VarGlob.SistemaAtivo.Id_Admlc}")
    ...
    Public Overrides Function GetByIdList(igrejasId As Integer) As List(Of IgrejasOnDTO)
        Dim columns As New Dictionary(Of String, Object)()
        Return BuscarLista(TabelaViews, columns, $"AND id_igreja = {igrejasId} AND id_admlc = {VarGlob.SistemaAtivo.Id_Admlc}")
    End Function

    Public Overrides Function GetAllList(Optional condicao As String = "") As List(Of IgrejasOnDTO)
        Dim columns As New Dictionary(Of String, Object)()
    ...
    Public Overrides Function GetByPart(part As String) As IgrejasOnDTO
        Throw New NotImplementedException()
    End Function

    Protected Overrides Function ConvertFromReader(reader As Common.DbDataReader) As IgrejasOnDTO
        Dim igrejas As New IgrejasOnDTO()
        ...
        If ColumnExists(reader, "id_tipo") AndAlso Not reader.IsDBNull(reader.GetOrdinal("id_tipo")) Then
            If reader.GetFieldType(reader.GetOrdinal("id_tipo")) = GetType(Int32) Then
                igrejas.Id_Tipo = reader.GetInt32(reader.GetOrdinal("id_tipo"))
            Else
        ...
        If ColumnExists(reader, "id_status") AndAlso Not reader.IsDBNull(reader.GetOrdinal("id_status")) Then
            If reader.GetFieldType(reader.GetOrdinal("id_status")) = GetType(Int32) Then
                igrejas.Id_Status = reader.GetInt32(reader.GetOrdinal("id_status"))
            Else
        ...
        ' Verifica se o campo "cod_setor" não é nulo e é do tipo string
        ...
        If ColumnExists(reader, "data_alter") AndAlso Not reader.IsDBNull(reader.GetOrdinal("data_alter")) Then
            If Not reader.IsDBNull(reader.GetOrdinal("data_alter")) Then
